module TimesheetsHelper
  def render_actions(timesheet)
      ...
      timesheet.actions[:admin].map {|a| if a[0] == 'Delete'; link_to(a[0], {:action => a[1], :id => timesheet}, :confirm => "Are you sure?"); elsif a[0] == 'Reject'; link_to(a[0], {:action => a[1], :id => timesheet}, :confirm => "Are you sure?"); else link_to(a[0], :action => a[1], :id => timesheet); end + " "}
